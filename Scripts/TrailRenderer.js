...
export class TrailRenderer extends THREE.Object3D {
  ...
  setHeadColor(color) {
    if (
      ...
      this.material.uniforms.headColor
    ) {
      this.material.uniforms.headColor.value = color;
    }
  }
  setTailColor(color) {
    if (
      this.material &&
      this.material.uniforms &&
      this.material.uniforms.tailColor
    ) {
      this.material.uniforms.tailColor.value = color;
    }
  }
